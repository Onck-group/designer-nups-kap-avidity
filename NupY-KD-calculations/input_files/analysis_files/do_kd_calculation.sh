...
echo "PROT1" | gmx polystat -f traj_comp.xtc -s MD.tpr -n kd.ndx -o prot_1_polystat.xvg -xvg none
echo "PROT2" | gmx polystat -f traj_comp.xtc -s MD.tpr -n kd.ndx -o prot_2_polystat.xvg -xvg none
...
gmx pairdist -f traj_comp.xtc -n kd.ndx -s MD.tpr -ref PROT1 -sel PROT2 -pbc -type min -o pairdist_min.xvg -xvg none
#the COM distance betwen both proteins
gmx pairdist -f traj_comp.xtc -s MD.tpr -n kd.ndx -ref PROT1 -sel PROT2 -selrpos whole_mol_com -seltype whole_mol_com -o pairdist_com.xvg -xvg none

python calculate_kd.py $box_size  
